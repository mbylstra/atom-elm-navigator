...
var _user$project$File$toFullPath = function (file) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'/',
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$String$join, '/', file.dirPath),
			A2(_elm_lang$core$Basics_ops['++'], '/', file.name)));
};
var _user$project$File$File = F5(
	function (a, b, c, d, e) {
		return {name: a, dirPath: b, fileType: c, absolute: d, filePath: e};
	});
var _user$project$File$FileTypeUnknown = {ctor: 'FileTypeUnknown'};
var _user$project$File$Elm = {ctor: 'Elm'};
var _user$project$File$parseFileType = function (filename) {
	return A2(_elm_lang$core$String$endsWith, '.elm', filename) ? _user$project$File$Elm : _user$project$File$FileTypeUnknown;
};
var _user$project$File$parseFilePath = function (filePath) {
	var _p0 = A2(_elm_lang$core$String$startsWith, '/', filePath) ? {
		ctor: '_Tuple2',
		_0: true,
		_1: _elm_lang$core$Tuple$second(
			A2(
				...
				_elm_lang$core$String$uncons(filePath)))
	} : {ctor: '_Tuple2', _0: false, _1: filePath};
	var absolute = _p0._0;
	var filePathTail = _p0._1;
	return function (_p1) {
		var _p2 = _p1;
		var _p3 = _p2._0;
		return {
			name: _p3,
			dirPath: _elm_lang$core$List$reverse(_p2._1),
			fileType: _user$project$File$parseFileType(_p3),
			absolute: absolute,
			filePath: filePath
		};
	}(
		A2(
			...
			_elm_community$list_extra$List_Extra$uncons(
				_elm_lang$core$List$reverse(
					A2(_elm_lang$core$String$split, '/', filePathTail)))));
};

var _user$project$Util$removeBasePath = F2(
	function (basePath, s) {
		return A3(_elm_community$string_extra$String_Extra$replace, basePath, '', s);
	});
var _user$project$Util$allEqual = function (xs) {
	return function (_p0) {
		return A2(
			F2(
				function (x, y) {
			...
			1,
			_elm_lang$core$Set$size(_p0));
	}(
		_elm_lang$core$Set$fromList(xs));
};
var _user$project$Util$commonStartsWith = function (strings) {
	var commonStartsWith_ = F2(
		function (strings_, startsWithAcc) {
			var unconsStrings = A2(_elm_lang$core$List$map, _elm_lang$core$String$uncons, strings_);
			return (!A2(_elm_lang$core$List$all, _elm_community$maybe_extra$Maybe_Extra$isJust, unconsStrings)) ? startsWithAcc : function (_p1) {
				var _p2 = _p1;
				var _p4 = _p2._0;
				if (!_user$project$Util$allEqual(_p4)) {
					return startsWithAcc;
				} else {
					...
					if (_p3.ctor === 'Nothing') {
						...
						return A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								startsWithAcc,
								_elm_lang$core$String$fromChar(_p3._0)));
					}
				}
			}(
				A3(
					...
					F2(
						function (_p6, _p5) {
							...
							return {
								ctor: '_Tuple2',
								_0: {ctor: '::', _0: _p7._0, _1: _p8._0},
								_1: {ctor: '::', _0: _p7._1, _1: _p8._1}
							};
						}),
					{
						ctor: '_Tuple2',
					...
					A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, unconsStrings)));
		});
	return A2(commonStartsWith_, strings, '');
};

var _user$project$SymbolNavigator$tagTypeView = function (tagType) {
	var tagTypeString = _elm_lang$core$Basics$toString(tagType);
	return A2(
		_elm_lang$html$Html$span,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class(
				A2(_elm_lang$core$Basics_ops['++'], 'elm-navigator-type elm-navigator-type-', tagTypeString)),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
};
var _user$project$SymbolNavigator$isTeaSymbol = function (symbol) {
	return A2(
		_elm_lang$core$List$member,
		symbol,
		{
...
var _user$project$SymbolNavigator$toHtmlAnchorId = function (filePath) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'esn--',
		A3(_elm_community$string_extra$String_Extra$replace, ' ', '_', filePath));
};
var _user$project$SymbolNavigator$groupByFile = function (tags) {
	return function (_p0) {
		var _p1 = _p0;
		var _p2 = _p1.maybePrevFile;
		if (_p2.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			return A2(
				...
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p2._0, _1: _p1.currTags},
					_1: {ctor: '[]'}
				});
		}
	}(
		A3(
			...
			F2(
				function (tag, _p3) {
					var _p4 = _p3;
					var _p7 = _p4.currTags;
					var _p5 = _p4.maybePrevFile;
					if (_p5.ctor === 'Nothing') {
						return {
							files: {ctor: '[]'},
							currTags: {
							...
							maybePrevFile: _elm_lang$core$Maybe$Just(tag.file)
						};
					} else {
						var _p6 = _p5._0;
						return _elm_lang$core$Native_Utils.eq(tag.file, _p6) ? _elm_lang$core$Native_Utils.update(
							_p4,
							{
								currTags: A2(
									_elm_lang$core$Basics_ops['++'],
				...
				}),
			{
				files: {ctor: '[]'},
				currTags: {ctor: '[]'},
				maybePrevFile: _elm_lang$core$Maybe$Nothing
			},
			tags));
};
var _user$project$SymbolNavigator$search = F2(
	function (keyword, allTags) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p8) {
				return A2(
...
var _user$project$SymbolNavigator$keepOnlyFileTags = F2(
	function (tags, file) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p9) {
...
var _user$project$SymbolNavigator$excludeFileTags = F2(
	function (tags, file) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p10) {
...
var _user$project$SymbolNavigator$init = {
	tags: {ctor: '[]'},
	currentFile: _elm_lang$core$Maybe$Nothing,
	searchKeyword: '',
	tagTypeFilter: _elm_lang$core$Maybe$Nothing
};
var _user$project$SymbolNavigator$filesUpdated = _elm_lang$core$Native_Platform.incomingPort(
	'filesUpdated',
										...
										return A2(
											...
											function (filePath) {
												return _elm_lang$core$Json_Decode$succeed(
													{context: context, lineNumber: lineNumber, symbol: symbol, type_: type_, filePath: filePath});
											},
...
var _user$project$SymbolNavigator$fileUpdated = _elm_lang$core$Native_Platform.incomingPort(
	'fileUpdated',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (filePath) {
			return A2(
				...
				function (rawTags) {
					return _elm_lang$core$Json_Decode$succeed(
						{filePath: filePath, rawTags: rawTags});
				},
				A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'filePath', _elm_lang$core$Json_Decode$string)));
var _user$project$SymbolNavigator$activeFileChanged = _elm_lang$core$Native_Platform.incomingPort(
	'activeFileChanged',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (filePath) {
		...
		A2(_elm_lang$core$Json_Decode$field, 'filePath', _elm_lang$core$Json_Decode$string)));
var _user$project$SymbolNavigator$goToLineInFile = _elm_lang$core$Native_Platform.outgoingPort(
	'goToLineInFile',
	function (v) {
		return {uri: v.uri, lineNumber: v.lineNumber};
	});
var _user$project$SymbolNavigator$focusDomElement = _elm_lang$core$Native_Platform.outgoingPort(
	'focusDomElement',
	function (v) {
		return {id: v.id};
	});
var _user$project$SymbolNavigator$Model = F4(
	function (a, b, c, d) {
		return {tags: a, currentFile: b, searchKeyword: c, tagTypeFilter: d};
	});
var _user$project$SymbolNavigator$RawTag = F5(
	function (a, b, c, d, e) {
		return {context: a, lineNumber: b, symbol: c, type_: d, filePath: e};
	});
var _user$project$SymbolNavigator$Tag = F5(
	function (a, b, c, d, e) {
		return {symbol: a, file: b, context: c, type_: d, lineNumber: e};
	});
var _user$project$SymbolNavigator$TagTypeUnknown = {ctor: 'TagTypeUnknown'};
var _user$project$SymbolNavigator$Port = {ctor: 'Port'};
var _user$project$SymbolNavigator$TypeAlias = {ctor: 'TypeAlias'};
var _user$project$SymbolNavigator$Type = {ctor: 'Type'};
var _user$project$SymbolNavigator$Function = {ctor: 'Function'};
var _user$project$SymbolNavigator$Constant = {ctor: 'Constant'};
var _user$project$SymbolNavigator$parseTagType = function (typeString) {
	var _p11 = typeString;
	switch (_p11) {
		case 'Function':
			return _user$project$SymbolNavigator$Function;
		case 'Constant':
			return _user$project$SymbolNavigator$Constant;
		case 'Type':
			return _user$project$SymbolNavigator$Type;
		case 'TypeAlias':
			return _user$project$SymbolNavigator$TypeAlias;
		case 'Port':
			return _user$project$SymbolNavigator$Port;
		default:
			return _user$project$SymbolNavigator$TagTypeUnknown;
	}
};
var _user$project$SymbolNavigator$convertRawTag = function (rawTag) {
	return {
		symbol: rawTag.symbol,
		lineNumber: rawTag.lineNumber,
		file: _user$project$File$parseFilePath(rawTag.filePath),
		context: rawTag.context,
		type_: _user$project$SymbolNavigator$parseTagType(rawTag.type_)
	};
};
var _user$project$SymbolNavigator$replaceTagsForFilePath = F2(
	function (_p12, currentTags) {
		var _p13 = _p12;
		var newTags = A2(_elm_lang$core$List$map, _user$project$SymbolNavigator$convertRawTag, _p13.rawTags);
		return function (_p14) {
			var _p15 = _p14;
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_p15.left,
				A2(_elm_lang$core$Basics_ops['++'], _p15.$new, _p15.right));
		}(
			A3(
				_elm_lang$core$List$foldl,
				F2(
					function (tag, _p16) {
						...
						var _p19 = _p17.left;
						var _p18 = _p17;
						return _elm_lang$core$Native_Utils.eq(tag.file.filePath, _p13.filePath) ? {left: _p19, $new: newTags, right: _p20} : (_elm_lang$core$Native_Utils.eq(
							_p17.$new,
							{ctor: '[]'}) ? _elm_lang$core$Native_Utils.update(
							_p18,
							{
								left: A2(
									_elm_lang$core$Basics_ops['++'],
...
var _user$project$SymbolNavigator$update = F2(
		...
		switch (_p21.ctor) {
			case 'NavigateToTag':
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$SymbolNavigator$goToLineInFile(
							{lineNumber: _p22.lineNumber, uri: _p22.file.filePath}),
						_1: {ctor: '[]'}
					});
			case 'SearchInputUpdated':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{searchKeyword: _p21._0}),
					{ctor: '[]'});
			case 'FilterByTagType':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{tagTypeFilter: _p21._0}),
					{ctor: '[]'});
			case 'FilesUpdated':
				var tags = A2(_elm_lang$core$List$map, _user$project$SymbolNavigator$convertRawTag, _p21._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'FileUpdated':
				var newTags = A2(
					_user$project$SymbolNavigator$replaceTagsForFilePath,
					{filePath: _p21._0.filePath, rawTags: _p21._0.rawTags},
					model.tags);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
					...
					{ctor: '[]'});
			default:
				var domId = _user$project$SymbolNavigator$toHtmlAnchorId(_p21._0.filePath);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
						_0: _user$project$SymbolNavigator$focusDomElement(
							{id: domId}),
						_1: {ctor: '[]'}
					});
		}
	});
var _user$project$SymbolNavigator$ActiveFileChanged = function (a) {
	return {ctor: 'ActiveFileChanged', _0: a};
};
var _user$project$SymbolNavigator$FileUpdated = function (a) {
	return {ctor: 'FileUpdated', _0: a};
};
var _user$project$SymbolNavigator$FilesUpdated = function (a) {
	return {ctor: 'FilesUpdated', _0: a};
};
var _user$project$SymbolNavigator$subscriptions = _elm_lang$core$Platform_Sub$batch(
	{
		ctor: '::',
		_0: _user$project$SymbolNavigator$filesUpdated(_user$project$SymbolNavigator$FilesUpdated),
		_1: {
			ctor: '::',
			_0: _user$project$SymbolNavigator$fileUpdated(_user$project$SymbolNavigator$FileUpdated),
			_1: {
				ctor: '::',
				_0: _user$project$SymbolNavigator$activeFileChanged(_user$project$SymbolNavigator$ActiveFileChanged),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$SymbolNavigator$FilterByTagType = function (a) {
	return {ctor: 'FilterByTagType', _0: a};
};
var _user$project$SymbolNavigator$tagTypeFilterItemView = F2(
	function (model, tagType) {
		var highlighted = function () {
			var _p23 = model.tagTypeFilter;
			if (_p23.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(tagType, _p23._0);
			} else {
				return false;
			}
		}();
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'esn-tag-type-filter-item', _1: true},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: A2(
									_elm_lang$core$Basics_ops['++'],
									'esn-tag-type-filter-',
									_elm_lang$core$Basics$toString(tagType)),
								_1: true
							},
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'esn-tag-type-filter-highlighted', _1: highlighted},
									_1: {ctor: '[]'}
								}
							}
						}
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$SymbolNavigator$FilterByTagType(
							_elm_lang$core$Maybe$Just(tagType))),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'});
	});
var _user$project$SymbolNavigator$tagTypeFilterView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('esn-tag-type-filter'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(_user$project$SymbolNavigator$tagTypeFilterItemView, model, _user$project$SymbolNavigator$Type),
			_1: {
				ctor: '::',
				_0: A2(_user$project$SymbolNavigator$tagTypeFilterItemView, model, _user$project$SymbolNavigator$TypeAlias),
				_1: {
					ctor: '::',
					_0: A2(_user$project$SymbolNavigator$tagTypeFilterItemView, model, _user$project$SymbolNavigator$Constant),
					_1: {
						ctor: '::',
						_0: A2(_user$project$SymbolNavigator$tagTypeFilterItemView, model, _user$project$SymbolNavigator$Function),
						_1: {
							ctor: '::',
							_0: A2(_user$project$SymbolNavigator$tagTypeFilterItemView, model, _user$project$SymbolNavigator$Port),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$SymbolNavigator$SearchInputUpdated = function (a) {
	return {ctor: 'SearchInputUpdated', _0: a};
};
var _user$project$SymbolNavigator$NavigateToTag = function (a) {
	return {ctor: 'NavigateToTag', _0: a};
};
var _user$project$SymbolNavigator$tagView = F2(
	function (basePath, tag) {
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'list-item', _1: true},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'tea-symbol',
								_1: _user$project$SymbolNavigator$isTeaSymbol(tag.symbol)
							},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$SymbolNavigator$NavigateToTag(tag)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('list-item-wrapper'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _user$project$SymbolNavigator$tagTypeView(tag.type_),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$span,
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(tag.symbol),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$SymbolNavigator$tagsView = F2(
	function (basePath, tags) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$SymbolNavigator$tagView(basePath),
				tags));
	});
var _user$project$SymbolNavigator$fileTagsView = F2(
	function (basePath, _p24) {
		var _p25 = _p24;
		var _p26 = _p25._0;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('esn-file-tags'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_0: _elm_lang$html$Html_Attributes$id(
							_user$project$SymbolNavigator$toHtmlAnchorId(_p26.filePath)),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_user$project$Util$removeBasePath, basePath, _p26.filePath)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(_user$project$SymbolNavigator$tagsView, basePath, _p25._1),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _user$project$SymbolNavigator$projectTagsView = F2(
	function (basePath, tags) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('esn-project-tags'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				_user$project$SymbolNavigator$fileTagsView(basePath),
				tags));
	});
var _user$project$SymbolNavigator$view = function (model) {
	var basePath = _user$project$Util$commonStartsWith(
		A2(
			_elm_lang$core$List$map,
			function (_p27) {
				return function (_) {
			...
			model.tags));
	var filteredTags = _elm_lang$core$Native_Utils.eq(model.searchKeyword, '') ? model.tags : A2(_user$project$SymbolNavigator$search, model.searchKeyword, model.tags);
	var projectTags = _user$project$SymbolNavigator$groupByFile(
		A2(
			_elm_lang$core$Maybe$withDefault,
			filteredTags,
			A2(
				_elm_lang$core$Maybe$map,
				_user$project$SymbolNavigator$excludeFileTags(filteredTags),
				model.currentFile)));
	var currentFileTags = A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
		A2(
			_elm_lang$core$Maybe$map,
			_user$project$SymbolNavigator$keepOnlyFileTags(filteredTags),
			model.currentFile));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('esn-main-view'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('native-key-bindings input-search'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$SymbolNavigator$SearchInputUpdated),
							_1: {
								ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$SymbolNavigator$projectTagsView, basePath, projectTags),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_user$project$SymbolNavigator$init,
			{ctor: '[]'}),
		update: _user$project$SymbolNavigator$update,
		view: _user$project$SymbolNavigator$view,
		subscriptions: function (_p0) {
			return _user$project$SymbolNavigator$subscriptions;
		}
	})();
